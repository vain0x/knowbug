// hspvar_core.h (本家hsp互換モード)

#ifndef IG_HSPVAR_CORE_H
#define IG_HSPVAR_CORE_H
...
#define HSPVAR_FLAG_COMOBJ 6
#define HSPVAR_FLAG_COMSTRUCT HSPVAR_FLAG_COMOBJ
//		HSPVAR_FLAG_VARIANT 7
#define HSPVAR_FLAG_USERDEF 8
#define HSPVAR_FLAG_MAX     HSPVAR_FLAG_USERDEF
