...
public:
	...
	void addCall( STRUCTDAT* stdat, void* prmstk );
...
#endif
	void addItem_prmstack ( STRUCTDAT* stdat, STRUCTPRM* stprm, const void* prmstack );
	void addItem_member   ( STRUCTDAT* stdat, STRUCTPRM* stprm, const void* member );
#ifdef with_Assoc
