...
extern const char* getStPrmName( const STRUCTPRM* pStPrm );
...
static inline const char* getNodeAnnotation(const char*) { return nullptr; }
static inline const char* getStPrmName( const STRUCTPRM* pStPrm ) { return nullptr; }
